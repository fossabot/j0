...
var iteratorSymbol = x$6.iterator;
...
if (!prototype$8.codePointAt) {
	prototype$8.codePointAt = codePointAt;
}
...
try {
	...
	x$20.prototype.forEach = x$5.prototype.forEach;
}
...
function readBlob(data, type) {
	var reader = new x$30();
	var promise = new x$29(function (resolve, reject) {
...
var viewClasses = [x$28, x$34, x$35, x$36, x$37, x$38, x$39, x$2, x$40];
