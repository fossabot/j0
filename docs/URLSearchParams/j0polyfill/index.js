...
var URLSearchParams = function (_StringList) {
	...
	function URLSearchParams(init) {
		...
		return _possibleConstructorReturn(this, (URLSearchParams.__proto__ || Object.getPrototypeOf(URLSearchParams)).call(this, init ? init.replace(/^\?/, '').split(separator).map(function (entry) {
...
tests(URLSearchParams, 'URLSearchParams#j0');
}())
