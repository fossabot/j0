...
var requestCount = new Date().getTime();
var queues = {};
...
module.exports = function (params) {
	...
	var promise = new Promise(function (resolve) {
		...
		return new Promise(function (resolve, reject) {
			...
			if (!params.withoutD) {
				queryParameters.push('d=' + base62(requestCount = requestCount + 1));
			}
			...
			if (data && !(data instanceof FormData) && isObject(data)) {
