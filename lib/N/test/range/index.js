...
describe('N.prototype.textDirection', function () {
	...
	[
		['-ms-writing-mode:bt-rl;writing-mode:vertical-rl;-webkit-writing-mode:vertical-rl;direction:rtl;unicode-bidi:bidi-override;', [directions.top, directions.left]],
		['direction:ltr;unicode-bidi:normal;', [directions.right, directions.bottom]],
		['-ms-writing-mode:tb-rl;writing-mode:vertical-rl;-webkit-writing-mode:vertical-rl;direction:ltr;unicode-bidi:normal;', [directions.bottom, directions.left]],
...
describe('N.prototype.modifyRange', function () {
	...
	(() => {
		...
		[
			...
			[
				'-ms-writing-mode:bt-rl;writing-mode:vertical-rl;-webkit-writing-mode:vertical-rl;direction:rtl;unicode-bidi:bidi-override;',
				'bt-rl',
				[
			...
			[
				'-ms-writing-mode:tb-rl;writing-mode:vertical-rl;-webkit-writing-mode:vertical-rl;direction:ltr;unicode-bidi:normal;',
				'tb-rl',
				[
					['top', text, offset - 2, text, offset - 2],
					['bottom', text, offset + 2, text, offset + 2],
