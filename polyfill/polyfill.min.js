!function() {
    ...
    function B(e) {
        ...
        return s(S(e).split("&"), function(e) {
            if (e) {
                var n = e.split("="), o = t(n), i = o[0], a = o.slice(1);
                i = et(i.replace(/\+/g, " ")), a = et(a.join("=").replace(/\+/g, " ")), r.append(i, a);
            }
        }), r;
    }
    /* eslint-disable no-bitwise */
    function F(t, e, r) {
        for (var n = jt[r], o = 0, i = 0; 0 < r--; ) {
            var a = 0 === r ? n : At, u = Et * i++;
            o |= (t[e + r] & a) << u;
        }
        return V.fromCharCode(o);
    }
    /* eslint-enable no-bitwise */
    function R(t) {
        for (var e = new Q(t), r = [], n = 0; n < e.length; n++) {
            var o = e[n], i = void 0;
    ...
    function I(e) {
        ...
        return e.replace(/\r?\n[\t ]+/, " ").split(/\r?\n/).forEach(function(e) {
            var n = e.split(":"), o = t(n), i = o[0], a = o.slice(1);
            i && r.append(S(i), S(a.join(":")));
        }), r;
    }
    function D(t, e) {
        return new Promise(function(r, n) {
            var o = new Tt(t, e), i = new XMLHttpRequest();
            i.onload = function() {
                var t = {
                    status: i.status,
  ...
  */
    ...
    var X = 9007199254740991, Y = Array.prototype.push;
    Array.from || (Array.from = l), String.prototype.repeat || (String.prototype.repeat = d);
    var J = window, V = J.String, Q = J.Uint8Array, W = J.ArrayBuffer, Z = J.DataView, $ = (J.location, 
    J.navigator, J.document, J.setTimeout), tt = J.clearTimeout, et = J.decodeURIComponent;
    ...
    var rt = window, nt = rt.setImmediate, ot = void 0;
    ot = y, $(function() {
        // if (postMessage) {
    ...
    var it = function(t) {
        return ot(t);
    }, at = 0, ut = 1, st = 2, ct = 3, ft = function t() {
        ...
        this.promise = new lt(f), /* eslint-enable no-use-before-define */
        this.onResolved = e, this.onRejected = r;
    }, lt = function() {
        function t(e) {
            n(this, t), this.deferreds = [], this.state = at, this.exec(e);
        }
        return C(t, [ {
            key: "is",
            value: function(t) {
            ...
            key: "reject",
            value: function(t) {
                this.state = st, this.value = t, this.finish();
            }
        }, {
            key: "finish",
            value: function() {
            ...
            value: function(t) {
                ...
                if (e.is(at)) return void c(e.deferreds, t);
                it(function() {
                    var r = t.promise, n = t.onResolved, o = void 0 === n ? null : n, i = t.onRejected, a = void 0 === i ? null : i, u = e.is(ut), s = u ? o : a;
    ...
    window.Promise = window.Promise || lt;
    var ht = function() {
        function t(e) {
            var r = this;
    ...
    dt && 1 === new dt([ [ 0, 0 ] ]).size && dt.prototype.forEach || (dt = ht), window.Map = dt, 
    Map.prototype[K] || (Map.prototype[K] = b);
    var yt = function() {
        function t(e) {
            var r = this;
            n(this, t), this.clear(), e && s(e, function(t) {
    ...
    vt && 1 === new vt([ 0 ]).size && vt.prototype.forEach || (vt = yt), window.Set = vt, 
    ...
    }(pt), bt = window, kt = bt.URLSearchParams;
    kt && new kt("?a=b").has("a") || (window.URLSearchParams = gt);
    var xt = function(t) {
        function o(t) {
            n(this, o);
            var r = [];
    ...
    window.Headers || (window.Headers = xt);
    var Ot = [ Uint8Array, Uint8ClampedArray, Uint16Array, Uint32Array, Int8Array, Int16Array, Int32Array, Float32Array, Float64Array ], _t = JSON.parse, At = 63, jt = [ At, 127, 31, 15, 7, 3, 1 ], Et = 6, Lt = function() {
        function t() {
        ...
        return C(t, [ {
            key: "initBody",
            value: function(t) {
                if (this.bodyInit = t, t) if (i(t)) this.bodyText = t; else if (L(t, Blob)) this.bodyBlob = t; else if (L(t, FormData)) this.bodyFormData = t; else if (L(t, URLSearchParams)) this.bodyText = t.toString(); else if (L(t, Z)) this.bodyArrayBuffer = U(t.buffer), 
                // IE 10-11 can't handle a DataView body.
                this.bodyInit = new Blob([ this.bodyArrayBuffer ]); else {
                    if (!L(t, W) && !P(t)) throw new Error("unsupported BodyInit type");
        ...
        function o(t) {
            ...
            !r.headers && a.headers || (a.headers = new xt(r.headers)), a.method = (r.method || a.method || "GET").toUpperCase(), 
        ...
        return r(o, t), C(o, [ {
            ...
            value: function(t, e, r) {
                ...
                return this.url = t.url, this.credentials = t.credentials, n || (this.headers = new xt(t.headers)), 
    ...
    }(Lt), Pt = 200, St = 300, Bt = [ 301, 302, 303, 307, 308 ], Ft = function(t) {
        function o(t) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            n(this, o);
            var i = e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this));
            return i.type = "default", i.status = "status" in r ? r.status : Pt, i.ok = i.status >= Pt && i.status < St, 
            i.statusText = "statusText" in r ? r.statusText : "OK", i.headers = new xt(r.headers), 
        ...
        return r(o, t), C(o, [ {
            ...
            key: "redirect",
            value: function(t, e) {
                if (Bt.indexOf(e) < 0) throw new RangeError("Invalid status code");
                return new o(null, {
                    status: e,
                    headers: {
                        location: t
    ...
    // }
    window.fetch = D, window.Body || (window.Body = Lt), window.Response || (window.Response = Ft), 
    window.Request || (window.Request = Tt), window.requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
        return $(function() {
            t(Date.now());
        }, 30);
