!function() {
    ...
    function a(t, e, r) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, o = t.length, a = t[z] ? t[z]() : t;
        if (0 <= o) {
            for (var u = n; u < o; u += 1) if (e.call(r, t[u], u, t)) return;
        } else if (i(a.next)) for (var s = 0; s < K; ) {
            var c = a.next(), f = c.value, l = c.done;
    ...
    function d(t) {
        for (var e = tt(t, 10), r = [], n = 0; n < e; n += 1) c(r, this);
        return h(r, "");
    }
    ...
    function L(t) {
        return 0 <= m(Tt, function(e) {
            return E(t, e);
        });
    }
    /* eslint-disable no-bitwise */
    function S(t, e, r) {
        for (var n = Ft[r], o = 0, i = 0; 0 < r--; ) {
            var a = 0 === r ? n : Bt, u = Rt * i++;
            o |= (t[e + r] & a) << u;
        }
    ...
    function T(t) {
        for (var e = new kt(t), r = [], n = 0; n < e.length; n++) {
            var o = e[n], i = void 0;
    ...
    function P(t, e) {
        var r = new qt(), n = new Promise(function(n, o) {
    ...
    function F(e) {
        var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : new Ct();
        return a(B(e).split("&"), function(e) {
            if (e) {
                var n = e.split("="), o = t(n), i = o[0], a = o.slice(1);
                i = Gt(i.replace(/\+/g, " ")), a = Gt(a.join("=").replace(/\+/g, " ")), r.append(i, a);
            }
        }), r;
    }
    function R(t) {
        if (t.slice) return t.slice(0);
        var e = new kt(t.byteLength);
        return e.set(new kt(t)), e.buffer;
    }
    function U(e) {
        var r = new Jt();
        return e.replace(/\r?\n[\t ]+/, " ").split(/\r?\n/).forEach(function(e) {
            var n = e.split(":"), o = t(n), i = o[0], a = o.slice(1);
            i && r.append(B(i), B(a.join(":")));
        }), r;
    }
    function I(t) {
        return void 0 === t;
    ...
    function N(t, e) {
        return new Dt(function(r, n) {
            var o = new Mt(t, e), i = new Vt();
            i.onload = function() {
                var t = {
                    status: i.status,
                    statusText: i.statusText,
                    headers: U(i.getAllResponseHeaders() || "")
                };
            ...
            i.responseType = "blob", a(o.headers, function(t) {
                var e = q(t, 2), r = e[0], n = e[1];
                i.setRequestHeader(r, n);
            }), i.send(I(o.bodyInit) ? null : o.bodyInit);
        });
    }
  ...
  */
    ...
    }), window.window), z = Symbol.iterator, K = 9007199254740991, X = window.Date, Y = window.TypeError, J = 16, V = function() {
        function t() {
            n(this, t), this.seed = X.now(), this.registry = [];
        }
        return C(t, [ {
            key: "get",
            value: function() {
            ...
            get: function() {
                ...
                return a([ "iterator", "match", "replace", "search", "split", "hasInstance", "isConcatSpreadable", "unscopables", "species", "toPrimitive", "toStringTag" ], function(e) {
                    t(e, r(e));
                }), t("for", function(t) {
                    return e.for(t);
                }), t("keyFor", function(t) {
    ...
    String.prototype.repeat || (String.prototype.repeat = d);
    ...
    var rt = M.setImmediate, nt = void 0;
    nt = y, et(function() {
        // if (postMessage) {
    ...
    var ot = function(t) {
        ...
        this.promise = new ft(f), /* eslint-enable no-use-before-define */
        this.onResolved = e, this.onRejected = r;
    }, ft = function() {
        function t(e) {
            n(this, t), this.deferreds = [], this.state = it, this.exec(e);
        }
        return C(t, [ {
            key: "is",
            value: function(t) {
            ...
            value: function(t) {
                try {
                    ...
                    this.value = t, p(t) ? (this.state = st, this.exec(function(e, r) {
                        t.then(e, r);
    ...
    M.Promise = M.Promise || ft;
    var lt = function() {
        function t(e) {
            var r = this;
            n(this, t), this.clear(), e && a(e, function(t) {
    ...
    ht && 1 === new ht([ [ 0, 0 ] ]).size && ht.prototype.forEach || (ht = lt), M.Map = ht, 
    Map.prototype[z] || (Map.prototype[z] = b);
    var dt = function() {
        function t(e) {
            var r = this;
            n(this, t), this.clear(), e && a(e, function(t) {
    ...
    yt && 1 === new yt([ 0 ]).size && yt.prototype.forEach || (yt = dt), M.Set = yt, 
    NodeList.prototype[z] || (NodeList.prototype[z] = k), HTMLCollection.prototype[z] || (HTMLCollection.prototype[z] = x), 
    NamedNodeMap.prototype[z] || (NamedNodeMap.prototype[z] = O);
    var vt = function() {
        function t(e) {
            var r = this;
        ...
        function o(t) {
            return n(this, o), e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, t ? l(t.replace(/^\?/, "").split(pt), function(t) {
                return t.split(wt);
            }) : null));
        }
        return r(o, t), C(o, [ {
    ...
    }(vt), gt = M.URLSearchParams;
    gt && new gt("?a=b").has("a") || (M.URLSearchParams = mt);
    var bt = function(t) {
        function o(t) {
            n(this, o);
            var r = [];
    ...
    M.Headers || (M.Headers = bt);
    var kt = window.Uint8Array, xt = window.Uint8ClampedArray, Ot = window.Uint16Array, _t = window.Uint32Array, jt = window.Int8Array, At = window.Int16Array, Et = window.Int32Array, Lt = window.Float32Array, St = window.Float64Array, Tt = [ kt, xt, Ot, _t, jt, At, Et, Lt, St ], Pt = JSON.parse, Bt = 63, Ft = [ Bt, 127, 31, 15, 7, 3, 1 ], Rt = 6, Ut = window.Blob, It = window.ArrayBuffer, Nt = window.DataView, Dt = window.Promise, qt = window.FileReader, Ct = window.FormData, Gt = window.decodeURIComponent, Ht = function() {
        function t() {
        ...
        return C(t, [ {
            key: "initBody",
            value: function(t) {
                if (this.bodyInit = t, t) if (u(t)) this.bodyText = t; else if (E(t, Ut)) this.bodyBlob = t; else if (E(t, Ct)) this.bodyFormData = t; else if (E(t, URLSearchParams)) this.bodyText = t.toString(); else if (E(t, Nt)) this.bodyArrayBuffer = R(t.buffer), 
                // IE 10-11 can't handle a DataView body.
                this.bodyInit = new Ut([ this.bodyArrayBuffer ]); else {
                    if (!E(t, It) && !L(t)) throw new Error("unsupported BodyInit type");
                    this.bodyArrayBuffer = R(t);
                } else this.bodyText = "";
                this.headers.get("content-type") || (u(t) ? this.headers.set("content-type", "text/plain;charset=UTF-8") : this.bodyBlob && this.bodyBlob.type ? this.headers.set("content-type", this.bodyBlob.type) : t instanceof URLSearchParams && this.headers.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"));
            }
        }, {
            key: "arrayBuffer",
            value: function() {
                return this.bodyArrayBuffer ? this.isUsed || Dt.resolve(this.bodyArrayBuffer) : this.blob().then(function(t) {
            ...
            value: function() {
                var t = this.isUsed;
                if (t) return t;
                if (this.bodyBlob) return Dt.resolve(this.bodyBlob);
                if (this.bodyArrayBuffer) return Dt.resolve(new Ut([ this.bodyArrayBuffer ]));
                if (this.bodyFormData) throw new Error("could not read FormData body as blob");
                return Dt.resolve(new Ut([ this.bodyText ]));
            }
        }, {
            key: "text",
            value: function() {
                ...
                if (this.bodyArrayBuffer) return Dt.resolve(T(this.bodyArrayBuffer));
                if (this.bodyFormData) throw new Error("could not read FormData body as text");
                return Dt.resolve(this.bodyText);
            }
        }, {
            key: "formData",
            value: function() {
            ...
            key: "isUsed",
            get: function() {
                if (this.bodyUsed) return Dt.reject(new Y("Already used"));
                this.bodyUsed = !0;
            }
        } ]), t;
    }(), Mt = function(t) {
        function o(t) {
            ...
            !r.headers && a.headers || (a.headers = new bt(r.headers)), a.method = (r.method || a.method || "GET").toUpperCase(), 
        ...
        return r(o, t), C(o, [ {
            ...
            value: function(t, e, r) {
                ...
                return this.url = t.url, this.credentials = t.credentials, n || (this.headers = new bt(t.headers)), 
    ...
    }(Ht), zt = 200, Kt = 300, Xt = [ 301, 302, 303, 307, 308 ], Yt = function(t) {
        function o(t) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            n(this, o);
            var i = e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this));
            return i.type = "default", i.status = "status" in r ? r.status : zt, i.ok = i.status >= zt && i.status < Kt, 
            i.statusText = "statusText" in r ? r.statusText : "OK", i.headers = new bt(r.headers), 
        ...
        return r(o, t), C(o, [ {
            ...
            key: "redirect",
            value: function(t, e) {
                if (Xt.indexOf(e) < 0) throw new RangeError("Invalid status code");
                return new o(null, {
                    status: e,
                    headers: {
                        location: t
    ...
    }(Ht), Jt = window.Headers, Vt = window.XMLHttpRequest;
    // if (!window.fetch) {
    // 	window.fetch = j0Fetch;
    // }
    M.fetch = N, M.Body || (M.Body = Ht), M.Response || (M.Response = Yt), M.Request || (M.Request = Mt), 
