!function() {
    ...
    function F(t, e, r) {
        for (var n = At[r], o = 0, i = 0; 0 < r--; ) {
            var a = 0 === r ? n : _t, u = jt * i++;
            o |= (t[e + r] & a) << u;
        }
    ...
    function D(t, e) {
        return new Promise(function(r, n) {
            var o = new Lt(t, e), i = new XMLHttpRequest();
            i.onload = function() {
                var t = {
                    status: i.status,
  ...
  */
    ...
    window.Promise = window.Promise || ft;
    var lt = function() {
        function t(e) {
            var r = this;
    ...
    ht && 1 === new ht([ [ 0, 0 ] ]).size && ht.prototype.forEach || (ht = lt), window.Map = ht, 
    ...
    yt && 1 === new yt([ 0 ]).size && yt.prototype.forEach || (yt = dt), window.Set = yt, 
    ...
    }(vt), gt = window, bt = gt.URLSearchParams;
    bt && new bt("?a=b").has("a") || (window.URLSearchParams = mt);
    var kt = function(t) {
        function o(t) {
            n(this, o);
            var r = [];
    ...
    window.Headers || (window.Headers = kt);
    var xt = [ Uint8Array, Uint8ClampedArray, Uint16Array, Uint32Array, Int8Array, Int16Array, Int32Array, Float32Array, Float64Array ], Ot = JSON.parse, _t = 63, At = [ _t, 127, 31, 15, 7, 3, 1 ], jt = 6, Et = function() {
        function t() {
    ...
    }(Et), Tt = 200, Pt = 300, St = [ 301, 302, 303, 307, 308 ], Bt = function(t) {
        function o(t) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            n(this, o);
            var i = e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this));
            return i.type = "default", i.status = "status" in r ? r.status : Tt, i.ok = i.status >= Tt && i.status < Pt, 
        ...
        return r(o, t), C(o, [ {
            ...
            key: "redirect",
            value: function(t, e) {
                if (St.indexOf(e) < 0) throw new RangeError("Invalid status code");
                return new o(null, {
                    status: e,
                    headers: {
                        location: t
    ...
    // }
    window.fetch = D, window.Body || (window.Body = Et), window.Response || (window.Response = Bt), 
    window.Request || (window.Request = Lt), window.requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
        return $(function() {
            t(Date.now());
        }, 30);
