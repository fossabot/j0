!function() {
    ...
    function d(t) {
        for (var e = parseInt(t, 10), r = [], n = 0; n < e; n += 1) f(r, this);
        return c(r, "");
    }
    ...
    function L(t) {
        return 0 <= m(mt, function(e) {
            return E(t, e);
        });
    }
    /* eslint-disable no-bitwise */
    function T(t, e, r) {
        for (var n = kt[r], o = 0, i = 0; 0 < r--; ) {
            var a = 0 === r ? n : gt, u = xt * i++;
            o |= (t[e + r] & a) << u;
        }
    ...
    function P(t) {
        for (var e = new Uint8Array(t), r = [], n = 0; n < e.length; n++) {
            var o = e[n], i = void 0;
            i = o < 128 ? 1 : o < 224 ? 2 : o < 240 ? 3 : o < 248 ? 4 : o < 252 ? 5 : 6, f(r, T(e, n, i)), 
            n += i - 1;
        }
        return r.join("");
    }
    ...
    function D(t, e) {
        return new Promise(function(r, n) {
            var o = new _t(t, e), i = new XMLHttpRequest();
            i.onload = function() {
                var t = {
                    status: i.status,
    ...
    }, H = require("from"), M = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}, z = (o(function(t) {
        /**
  ...
  */
        !function(e) {
            ...
            function f(t, e) {
                ...
                e.arg = p), e.delegate = null, T) : i : (e.method = "throw", e.arg = new TypeError("iterator result is not an object"), 
                e.delegate = null, T);
            }
            function l(t) {
                var e = {
            ...
            var A = "suspendedStart", j = "suspendedYield", E = "executing", L = "completed", T = {}, P = {};
            P[g] = function() {
                return this;
            };
            var S = Object.getPrototypeOf, B = S && S(S(y([])));
            B && B !== w && m.call(B, g) && (// This environment has a native %IteratorPrototype%; use it instead
            // of the polyfill.
            P = B);
            var F = a.prototype = o.prototype = Object.create(P);
            ...
            F[g] = function() {
                ...
                delegateYield: function(t, e, r) {
                    ...
                    return this.delegate = {
                        ...
                        resultName: e,
                        nextLoc: r
                    }, "next" === this.method && (this.arg = p), T;
                }
            };
        }(// Among the various tricks for obtaining a reference to the global
        // object, this seems to be the most reliable technique that does not
        // use indirect eval (which violates Content Security Policy).
        "object" === (void 0 === M ? "undefined" : G(M)) ? M : "object" === ("undefined" == typeof window ? "undefined" : G(window)) ? window : "object" === ("undefined" == typeof self ? "undefined" : G(self)) ? self : M);
    }), Symbol.iterator), K = 9007199254740991, X = 16, Y = function() {
        function t() {
        ...
        return C(t, [ {
            key: "get",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Date.now(), r = "Symbol(" + t + ")" + (this.seed + this.registry.length).toString(X);
    ...
    window.Symbol || (window.Symbol = J);
    var V = Array.prototype;
    V[z] || (V[z] = s), console.log(Object, c);
    var Q = Array.prototype.push;
    H.Array.from || (H.Array.from = h), String.prototype.repeat || (String.prototype.repeat = d), 
    // import postMessage from '../postMessage';
    // import addEventListner from '../dom/addEventListener';
    window.immediateId || (window.immediateId = 0), window.immediateId += 1;
    var W = window, Z = W.setImmediate, $ = void 0;
    ...
    var tt = function(t) {
        return $(t);
    }, et = 0, rt = 1, nt = 2, ot = 3, it = function t() {
        ...
        this.promise = new at(l), /* eslint-enable no-use-before-define */
        this.onResolved = e, this.onRejected = r;
    }, at = function() {
        function t(e) {
            n(this, t), this.deferreds = [], this.state = et, this.exec(e);
        }
        return C(t, [ {
            key: "is",
            value: function(t) {
            ...
            value: function(t) {
                try {
                    ...
                    this.value = t, p(t) ? (this.state = ot, this.exec(function(e, r) {
                        t.then(e, r);
                    })) : this.state = rt, this.finish();
                } catch (t) {
                    this.reject(t);
                }
            }
            ...
            value: function(t) {
                ...
                var e = this; e.is(ot); ) e = e.value;
                if (e.is(et)) return void f(e.deferreds, t);
                tt(function() {
                    var r = t.promise, n = t.onResolved, o = void 0 === n ? null : n, i = t.onRejected, a = void 0 === i ? null : i, u = e.is(rt), s = u ? o : a;
    ...
    window.Promise = window.Promise || at;
    var ut = function() {
        function t(e) {
            var r = this;
    ...
    st && 1 === new st([ [ 0, 0 ] ]).size && st.prototype.forEach || (st = ut), window.Map = st, 
    Map.prototype[z] || (Map.prototype[z] = g);
    var ct = function() {
        function t(e) {
            var r = this;
            n(this, t), this.clear(), e && a(e, function(t) {
    ...
    ft && 1 === new ft([ 0 ]).size && ft.prototype.forEach || (ft = ct), window.Set = ft, 
    ...
    var lt = function() {
        function t(e) {
            var r = this;
            n(this, t), this.clear(), e && h(e, function(t) {
                var e = q(t, 2), n = e[0], o = e[1];
                r.append(n, o);
            });
        }
        ...
        function o(t) {
            return n(this, o), e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, t ? h(t.replace(/^\?/, "").split(ht), function(t) {
                return t.split(dt);
            }) : null));
        }
        return r(o, t), C(o, [ {
    ...
    }(lt), vt = window, pt = vt.URLSearchParams;
    pt && new pt("?a=b").has("a") || (window.URLSearchParams = yt);
    var wt = function(t) {
        function o(t) {
            n(this, o);
            var r = [];
                ...
                return {
                    next: function() {
                        for (;;) {
                            ...
                            if (i || r.indexOf(a) < 0) return f(r, a), {
                                value: [ a, t.get(a) ],
                                done: i
                            };
                        }
    ...
    window.Headers || (window.Headers = wt);
    var mt = [ Uint8Array, Uint8ClampedArray, Uint16Array, Uint32Array, Int8Array, Int16Array, Int32Array, Float32Array, Float64Array ], bt = JSON.parse, gt = 63, kt = [ gt, 127, 31, 15, 7, 3, 1 ], xt = 6, Ot = function() {
        function t() {
        ...
        return C(t, [ {
            key: "initBody",
            value: function(t) {
                if (this.bodyInit = t, t) if (u(t)) this.bodyText = t; else if (E(t, Blob)) this.bodyBlob = t; else if (E(t, FormData)) this.bodyFormData = t; else if (E(t, URLSearchParams)) this.bodyText = t.toString(); else if (E(t, DataView)) this.bodyArrayBuffer = R(t.buffer), 
                // IE 10-11 can't handle a DataView body.
                this.bodyInit = new Blob([ this.bodyArrayBuffer ]); else {
                    if (!E(t, ArrayBuffer) && !L(t)) throw new Error("unsupported BodyInit type");
            ...
            value: function() {
                ...
                if (this.bodyArrayBuffer) return Promise.resolve(P(this.bodyArrayBuffer));
        ...
        function o(t) {
            ...
            !r.headers && a.headers || (a.headers = new wt(r.headers)), a.method = (r.method || a.method || "GET").toUpperCase(), 
        ...
        return r(o, t), C(o, [ {
            ...
            value: function(t, e, r) {
                ...
                return this.url = t.url, this.credentials = t.credentials, n || (this.headers = new wt(t.headers)), 
    ...
    }(Ot), At = 200, jt = 300, Et = [ 301, 302, 303, 307, 308 ], Lt = function(t) {
        function o(t) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            n(this, o);
            var i = e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this));
            return i.type = "default", i.status = "status" in r ? r.status : At, i.ok = i.status >= At && i.status < jt, 
            i.statusText = "statusText" in r ? r.statusText : "OK", i.headers = new wt(r.headers), 
        ...
        return r(o, t), C(o, [ {
            ...
            key: "redirect",
            value: function(t, e) {
                if (Et.indexOf(e) < 0) throw new RangeError("Invalid status code");
                return new o(null, {
                    status: e,
                    headers: {
                        location: t
    ...
    // }
    window.fetch = D, window.Body || (window.Body = Ot), window.Response || (window.Response = Lt), 
    window.Request || (window.Request = _t), window.requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
