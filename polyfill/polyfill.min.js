!function() {
    ...
    function u(t, e, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, o = t.length, i = t[Rt] ? t[Rt]() : t;
        if (0 <= o) {
    ...
    function F(t, e, n) {
        for (var r = fe[n], o = 0, i = 0; 0 < n--; ) {
            var a = 0 === n ? r : ce, u = le * i++;
            o |= (t[e + n] & a) << u;
        }
  ...
  */
        ...
        return C(t, [ {
            key: "get",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Date.now(), n = "Symbol(" + t + ")" + (this.seed + this.registry.length).toString(It);
    ...
    var Mt = function(t) {
        ...
        function t(e) {
            r(this, t), this.deferreds = [], this.state = zt, this.exec(e);
        }
        return C(t, [ {
            key: "is",
            value: function(t) {
            ...
            value: function(t) {
                try {
                    ...
                    this.value = t, p(t) ? (this.state = Yt, this.exec(function(e, n) {
                        t.then(e, n);
            ...
            value: function(t) {
                ...
                Mt(function() {
                    var n = t.promise, r = t.onResolved, o = void 0 === r ? null : r, i = t.onRejected, a = void 0 === i ? null : i, u = e.is(Kt), s = u ? o : a;
    ...
    window.Promise = window.Promise || Vt;
    var Qt = function() {
        function t(e) {
            var n = this;
    ...
    Wt && 1 === new Wt([ [ 0, 0 ] ]).size && Wt.prototype.forEach || (Wt = Qt), window.Map = Wt, 
    ...
    $t && 1 === new $t([ 0 ]).size && $t.prototype.forEach || ($t = Zt), window.Set = $t, 
    ...
    var te = function() {
        ...
        function o(t) {
            return r(this, o), e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, t ? l(t.replace(/^\?/, "").split(ee), function(t) {
                return t.split(ne);
            }) : null));
        }
        return n(o, t), C(o, [ {
    ...
    }(te), oe = window, ie = oe.URLSearchParams;
    ie && new ie("?a=b").has("a") || (window.URLSearchParams = re);
    var ae = function(t) {
        function o(t) {
            r(this, o);
            var n = [];
    ...
    window.Headers || (window.Headers = ae);
    var ue = [ lt, dt, vt, wt, gt, kt, Ot, jt, Et ], se = JSON.parse, ce = 63, fe = [ ce, 127, 31, 15, 7, 3, 1 ], le = 6, he = function() {
        function t() {
        ...
        function o(t) {
            ...
            !n.headers && a.headers || (a.headers = new ae(n.headers)), a.method = (n.method || a.method || "GET").toUpperCase(), 
        ...
        return n(o, t), C(o, [ {
            ...
            value: function(t, e, n) {
                ...
                return this.url = t.url, this.credentials = t.credentials, r || (this.headers = new ae(t.headers)), 
    ...
    }(he), ye = 200, ve = 300, pe = [ 301, 302, 303, 307, 308 ], we = function(t) {
        function o(t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            r(this, o);
            var i = e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this));
            return i.type = "default", i.status = "status" in n ? n.status : ye, i.ok = i.status >= ye && i.status < ve, 
            i.statusText = "statusText" in n ? n.statusText : "OK", i.headers = new ae(n.headers), 
        ...
        return n(o, t), C(o, [ {
            ...
            key: "redirect",
            value: function(t, e) {
                if (pe.indexOf(e) < 0) throw new RangeError("Invalid status code");
                return new o(null, {
                    status: e,
                    headers: {
                        location: t
    ...
    // }
    window.fetch = D, window.Body || (window.Body = he), window.Response || (window.Response = we), 
    window.Request || (window.Request = de), M.requestAnimationFrame = M.requestAnimationFrame || M.mozRequestAnimationFrame || M.webkitRequestAnimationFrame || M.msRequestAnimationFrame || function(t) {
        return rt(function() {
            t(Date.now());
        }, 30);
