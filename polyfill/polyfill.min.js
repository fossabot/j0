!function() {
    ...
    function u(t, e, r) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, o = t.length, i = t[It] ? t[It]() : t;
        if (0 <= o) {
            for (var u = n; u < o; u += 1) if (e.call(r, t[u], u, t)) return;
        } else if (a(i.next)) for (var s = 0; s < Nt; ) {
    ...
    function c(t) {
        for (var e = arguments.length, r = Y(e > 1 ? e - 1 : 0), n = 1; n < e; n++) r[n - 1] = arguments[n];
        return Ht.apply(t, r);
    }
    function f(t) {
        return t;
    ...
    function d(t) {
        for (var e = $(t, 10), r = [], n = 0; n < e; n += 1) c(r, this);
        return h(r, "");
    }
    ...
    function B(e) {
        ...
        return u(P(e).split("&"), function(e) {
            if (e) {
                var n = e.split("="), o = t(n), i = o[0], a = o.slice(1);
                i = ct(i.replace(/\+/g, " ")), a = ct(a.join("=").replace(/\+/g, " ")), r.append(i, a);
            }
        }), r;
    }
    /* eslint-disable no-bitwise */
    function F(t, e, r) {
        for (var n = le[r], o = 0, i = 0; 0 < r--; ) {
            var a = 0 === r ? n : fe, u = he * i++;
            o |= (t[e + r] & a) << u;
        }
    ...
    function R(t) {
        for (var e = new dt(t), r = [], n = 0; n < e.length; n++) {
            var o = e[n], i = void 0;
            i = o < 128 ? 1 : o < 224 ? 2 : o < 240 ? 3 : o < 248 ? 4 : o < 252 ? 5 : 6, c(r, F(e, n, i)), 
            n += i - 1;
        }
        return r.join("");
    }
    ...
    function I(e) {
        ...
        return e.replace(/\r?\n[\t ]+/, " ").split(/\r?\n/).forEach(function(e) {
            var n = e.split(":"), o = t(n), i = o[0], a = o.slice(1);
            i && r.append(P(i), P(a.join(":")));
        }), r;
    }
    function N(t, e) {
        return new Ft(function(r, n) {
            var o = new ye(t, e), i = new Pt();
            i.onload = function() {
                var t = {
                    status: i.status,
  ...
  */
        !function(e) {
            ...
            function s(t) {
                ...
                "object" === G(e.process) && e.process.domain && (r = e.process.domain.bind(r));
                var i;
            ...
            _ = e.regeneratorRuntime = O ? t.exports : {}, _.wrap = r;
    ...
    }), window), z = window, K = z.String, X = window, Y = X.Array, J = window, V = J.Object, Q = window, W = Q.Date, Z = window, $ = Z.parseInt, tt = window, et = tt.ArrayBuffer, rt = window, nt = rt.DataView, ot = window, it = ot.setTimeout, at = window, ut = at.clearTimeout, st = window, ct = st.decodeURIComponent, ft = window, lt = ft.TypeError, ht = window, dt = ht.Uint8Array, yt = window, vt = yt.Uint8ClampedArray, pt = window, wt = pt.Uint16Array, mt = window, gt = mt.Uint32Array, bt = window, kt = bt.Int8Array, xt = window, Ot = xt.Int16Array, _t = window, jt = _t.Int32Array, At = window, Et = At.Float32Array, Lt = window, St = Lt.Float64Array, Tt = window, Pt = Tt.XMLHttpRequest, Bt = window, Ft = Bt.Promise, Rt = window, Ut = Rt.Blob, It = Symbol.iterator, Nt = 9007199254740991, Dt = 16, qt = function() {
        function t() {
            n(this, t), this.seed = W.now(), this.registry = [];
        }
        return C(t, [ {
            key: "get",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : W.now(), r = "Symbol(" + t + ")" + (this.seed + this.registry.length).toString(Dt);
    ...
    M.Symbol || (M.Symbol = Ct);
    var Gt = Y.prototype;
    Gt[It] || (Gt[It] = s);
    var Ht = Y.prototype.push;
    ...
    var Mt = M.setImmediate, zt = void 0;
    zt = y, it(function() {
        // if (postMessage) {
    ...
    var Kt = function(t) {
        return zt(t);
    }, Xt = 0, Yt = 1, Jt = 2, Vt = 3, Qt = function t() {
        ...
        this.promise = new Wt(f), /* eslint-enable no-use-before-define */
        this.onResolved = e, this.onRejected = r;
    }, Wt = function() {
        function t(e) {
            n(this, t), this.deferreds = [], this.state = Xt, this.exec(e);
        }
        return C(t, [ {
            key: "is",
            value: function(t) {
            ...
            value: function(t) {
                try {
                    ...
                    this.value = t, p(t) ? (this.state = Vt, this.exec(function(e, r) {
                        t.then(e, r);
                    })) : this.state = Yt, this.finish();
                } catch (t) {
                    this.reject(t);
                }
            }
            ...
            key: "reject",
            value: function(t) {
                this.state = Jt, this.value = t, this.finish();
            }
        }, {
            key: "finish",
            value: function() {
            ...
            value: function(t) {
                ...
                var e = this; e.is(Vt); ) e = e.value;
                if (e.is(Xt)) return void c(e.deferreds, t);
                Kt(function() {
                    var r = t.promise, n = t.onResolved, o = void 0 === n ? null : n, i = t.onRejected, a = void 0 === i ? null : i, u = e.is(Yt), s = u ? o : a;
    ...
    M.Promise = M.Promise || Wt;
    var Zt = function() {
        function t(e) {
            var r = this;
            n(this, t), this.clear(), e && u(e, function(t) {
    ...
    $t && 1 === new $t([ [ 0, 0 ] ]).size && $t.prototype.forEach || ($t = Zt), M.Map = $t, 
    Map.prototype[It] || (Map.prototype[It] = b);
    var te = function() {
        function t(e) {
            var r = this;
            n(this, t), this.clear(), e && u(e, function(t) {
        ...
        return C(t, [ {
            ...
            value: function(t) {
                ...
                return 0 <= e && g(this.data, e, 1), 0 <= e;
            }
        }, {
            key: "forEach",
            value: function(t, e) {
    ...
    ee && 1 === new ee([ 0 ]).size && ee.prototype.forEach || (ee = te), M.Set = ee, 
    NodeList.prototype[It] || (NodeList.prototype[It] = k), HTMLCollection.prototype[It] || (HTMLCollection.prototype[It] = x), 
    NamedNodeMap.prototype[It] || (NamedNodeMap.prototype[It] = O);
    var re = function() {
        function t(e) {
            var r = this;
        ...
        function o(t) {
            return n(this, o), e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, t ? l(t.replace(/^\?/, "").split(ne), function(t) {
                return t.split(oe);
            }) : null));
        }
        return r(o, t), C(o, [ {
    ...
    }(re), ae = M.URLSearchParams;
    ae && new ae("?a=b").has("a") || (M.URLSearchParams = ie);
    var ue = function(t) {
        function o(t) {
            n(this, o);
            var r = [];
        ...
        return r(o, t), C(o, [ {
            key: "indexOf",
            value: function(t) {
                return D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "indexOf", this).call(this, A(t));
            }
        }, {
            key: "has",
            value: function(t) {
                return D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "has", this).call(this, A(t));
            }
        }, {
            key: "append",
            value: function(t, e) {
                return D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "append", this).call(this, A(t), e);
            }
        }, {
            key: "set",
            value: function(t, e) {
                return D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "set", this).call(this, A(t), e);
            }
        }, {
            key: "delete",
            value: function(t) {
                return D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "delete", this).call(this, A(t));
            }
        }, {
            key: "get",
            value: function(t) {
                return D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "getAll", this).call(this, A(t)).join(",");
            }
        }, {
            key: "entries",
            value: function() {
                var t = this, e = D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "entries", this).call(this), r = [];
                return {
                    next: function() {
                        for (;;) {
    ...
    M.Headers || (M.Headers = ue);
    var se = [ dt, vt, wt, gt, kt, Ot, jt, Et, St ], ce = JSON.parse, fe = 63, le = [ fe, 127, 31, 15, 7, 3, 1 ], he = 6, de = function() {
        function t() {
        ...
        return C(t, [ {
            key: "initBody",
            value: function(t) {
                if (this.bodyInit = t, t) if (i(t)) this.bodyText = t; else if (L(t, Ut)) this.bodyBlob = t; else if (L(t, FormData)) this.bodyFormData = t; else if (L(t, URLSearchParams)) this.bodyText = t.toString(); else if (L(t, nt)) this.bodyArrayBuffer = U(t.buffer), 
                // IE 10-11 can't handle a DataView body.
                this.bodyInit = new Ut([ this.bodyArrayBuffer ]); else {
                    if (!L(t, et) && !T(t)) throw new Error("unsupported BodyInit type");
        ...
        function o(t) {
            ...
            !r.headers && a.headers || (a.headers = new ue(r.headers)), a.method = (r.method || a.method || "GET").toUpperCase(), 
        ...
        return r(o, t), C(o, [ {
            ...
            value: function(t, e, r) {
                ...
                return this.url = t.url, this.credentials = t.credentials, n || (this.headers = new ue(t.headers)), 
    ...
    }(de), ve = 200, pe = 300, we = [ 301, 302, 303, 307, 308 ], me = function(t) {
        function o(t) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            n(this, o);
            var i = e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this));
            return i.type = "default", i.status = "status" in r ? r.status : ve, i.ok = i.status >= ve && i.status < pe, 
            i.statusText = "statusText" in r ? r.statusText : "OK", i.headers = new ue(r.headers), 
        ...
        return r(o, t), C(o, [ {
            ...
            key: "redirect",
            value: function(t, e) {
                if (we.indexOf(e) < 0) throw new RangeError("Invalid status code");
                return new o(null, {
                    status: e,
                    headers: {
                        location: t
    ...
    // }
    M.fetch = N, M.Body || (M.Body = de), M.Response || (M.Response = me), M.Request || (M.Request = ye), 
