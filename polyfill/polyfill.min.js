!function() {
    ...
    function i(t, e) {
        var n = new Nt(), r = new Promise(function(r, o) {
    ...
    function s(t, e, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, o = t.length, i = t[Dt] ? t[Dt]() : t;
        if (0 <= o) {
            for (var a = r; a < o; a += 1) if (e.call(n, t[a], a, t)) return;
        } else if (u(i.next)) for (var s = 0; s < qt; ) {
    ...
    function h(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : l, n = arguments[2], r = [];
    ...
    function y(t) {
        for (var e = $(t, 10), n = [], r = 0; r < e; r += 1) f(n, this);
        return d(n, "");
    }
    ...
    function m(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : l, n = arguments[2], r = void 0;
        return s(t, function(o, i) {
            if (e.call(n, o, i, t)) return r = o, !0;
        }), r;
    }
    function g(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : l, n = arguments[2], r = -1;
        return s(t, function(o, i) {
    ...
    function B(e) {
        ...
        return s(P(e).split("&"), function(e) {
            if (e) {
                var r = e.split("="), o = t(r), i = o[0], a = o.slice(1);
                i = ct(i.replace(/\+/g, " ")), a = ct(a.join("=").replace(/\+/g, " ")), n.append(i, a);
            }
        }), n;
    }
    /* eslint-disable no-bitwise */
    function F(t, e, n) {
        for (var r = de[n], o = 0, i = 0; 0 < n--; ) {
            var a = 0 === n ? r : he, u = ye * i++;
            o |= (t[e + n] & a) << u;
        }
    ...
    function R(t) {
        for (var e = new dt(t), n = [], r = 0; r < e.length; r++) {
            var o = e[r], i = void 0;
            i = o < 128 ? 1 : o < 224 ? 2 : o < 240 ? 3 : o < 248 ? 4 : o < 252 ? 5 : 6, f(n, F(e, r, i)), 
            r += i - 1;
        }
        return n.join("");
    }
    function U(t) {
        ...
        var e = new dt(t.byteLength);
        return e.set(new dt(t)), e.buffer;
    }
    function I(e) {
        var n = new Headers();
        return e.replace(/\r?\n[\t ]+/, " ").split(/\r?\n/).forEach(function(e) {
            var r = e.split(":"), o = t(r), i = o[0], a = o.slice(1);
            i && n.append(P(i), P(a.join(":")));
        }), n;
    }
    function N(t, e) {
        return new Ft(function(n, r) {
            var o = new pe(t, e), i = new Pt();
            i.onload = function() {
                var t = {
                    status: i.status,
            ...
            }), i.send(L(o.bodyInit) ? null : o.bodyInit);
        });
    }
  ...
  */
        !function(e) {
            ...
            var p, w = Object.prototype, m = w.hasOwnProperty, g = "function" == typeof Symbol ? Symbol : {}, b = g.iterator || "@@iterator", k = g.asyncIterator || "@@asyncIterator", x = g.toStringTag || "@@toStringTag", O = !0, _ = e.regeneratorRuntime;
    ...
    }), window), z = window, K = z.String, X = window, Y = X.Array, J = window, V = J.Object, Q = window, W = Q.Date, Z = window, $ = Z.parseInt, tt = window, et = tt.ArrayBuffer, nt = window, rt = nt.DataView, ot = window, it = ot.setTimeout, at = window, ut = at.clearTimeout, st = window, ct = st.decodeURIComponent, ft = window, lt = ft.TypeError, ht = window, dt = ht.Uint8Array, yt = window, vt = yt.Uint8ClampedArray, pt = window, wt = pt.Uint16Array, mt = window, gt = mt.Uint32Array, bt = window, kt = bt.Int8Array, xt = window, Ot = xt.Int16Array, _t = window, jt = _t.Int32Array, At = window, Et = At.Float32Array, Lt = window, St = Lt.Float64Array, Tt = window, Pt = Tt.XMLHttpRequest, Bt = window, Ft = Bt.Promise, Rt = window, Ut = Rt.Blob, It = window, Nt = It.FileReader, Dt = Symbol.iterator, qt = 9007199254740991, Ct = 16, Gt = function() {
        function t() {
            r(this, t), this.seed = W.now(), this.registry = [];
        }
        return C(t, [ {
            key: "get",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : W.now(), n = "Symbol(" + t + ")" + (this.seed + this.registry.length).toString(Ct);
            ...
            value: function(t) {
                ...
                throw new lt("Symbol.for was called with non-string: " + t);
            }
        }, {
            key: "keyFor",
            value: function(t) {
            ...
            get: function() {
                ...
                return s([ "iterator", "match", "replace", "search", "split", "hasInstance", "isConcatSpreadable", "unscopables", "species", "toPrimitive", "toStringTag" ], function(e) {
                    t(e, n(e));
                }), t("for", function(t) {
                    return e.for(t);
                }), t("keyFor", function(t) {
    ...
    M.Symbol || (M.Symbol = Ht);
    var Mt = Y.prototype;
    Mt[Dt] || (Mt[Dt] = c);
    var zt = Y.prototype.push;
    Y.from || (Y.from = h), String.prototype.repeat || (String.prototype.repeat = y), 
    // import postMessage from '../postMessage';
    // import addEventListner from '../dom/addEventListener';
    M.immediateId || (M.immediateId = 0), M.immediateId += 1;
    var Kt = M.setImmediate, Xt = void 0;
    Xt = v, it(function() {
        // if (postMessage) {
    ...
    var Yt = function(t) {
        return Xt(t);
    }, Jt = 0, Vt = 1, Qt = 2, Wt = 3, Zt = function t() {
        ...
        this.promise = new $t(l), /* eslint-enable no-use-before-define */
        this.onResolved = e, this.onRejected = n;
    }, $t = function() {
        function t(e) {
            r(this, t), this.deferreds = [], this.state = Jt, this.exec(e);
        }
        return C(t, [ {
            key: "is",
            value: function(t) {
            ...
            value: function(t) {
                try {
                    if (t === this) throw new lt("A promise cannot be resolved with itself");
                    this.value = t, w(t) ? (this.state = Wt, this.exec(function(e, n) {
                        t.then(e, n);
                    })) : this.state = Vt, this.finish();
                } catch (t) {
                    this.reject(t);
                }
            }
            ...
            key: "reject",
            value: function(t) {
                this.state = Qt, this.value = t, this.finish();
            }
        }, {
            key: "finish",
            value: function() {
            ...
            value: function(t) {
                ...
                var e = this; e.is(Wt); ) e = e.value;
                if (e.is(Jt)) return void f(e.deferreds, t);
                Yt(function() {
                    var n = t.promise, r = t.onResolved, o = void 0 === r ? null : r, i = t.onRejected, a = void 0 === i ? null : i, u = e.is(Vt), s = u ? o : a;
    ...
    M.Promise = M.Promise || $t;
    var te = function() {
        function t(e) {
            var n = this;
            r(this, t), this.clear(), e && s(e, function(t) {
        ...
        return C(t, [ {
            ...
            value: function(t, e) {
                ...
                return 0 <= n ? this.data[n][1] = e : f(this.data, [ t, e ]), this;
            }
        }, {
            key: "get",
            value: function(t) {
    ...
    ee && 1 === new ee([ [ 0, 0 ] ]).size && ee.prototype.forEach || (ee = te), M.Map = ee, 
    Map.prototype[Dt] || (Map.prototype[Dt] = k);
    var ne = function() {
        function t(e) {
            var n = this;
            r(this, t), this.clear(), e && s(e, function(t) {
    ...
    re && 1 === new re([ 0 ]).size && re.prototype.forEach || (re = ne), M.Set = re, 
    NodeList.prototype[Dt] || (NodeList.prototype[Dt] = x), HTMLCollection.prototype[Dt] || (HTMLCollection.prototype[Dt] = O), 
    NamedNodeMap.prototype[Dt] || (NamedNodeMap.prototype[Dt] = _);
    var oe = function() {
        function t(e) {
            var n = this;
            r(this, t), this.clear(), e && h(e, function(t) {
                var e = q(t, 2), r = e[0], o = e[1];
                n.append(r, o);
            });
        }
        ...
        function o(t) {
            return r(this, o), e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, t ? h(t.replace(/^\?/, "").split(ie), function(t) {
                return t.split(ae);
            }) : null));
        }
        return n(o, t), C(o, [ {
    ...
    }(oe), se = M.URLSearchParams;
    se && new se("?a=b").has("a") || (M.URLSearchParams = ue);
    var ce = function(t) {
        function o(t) {
            r(this, o);
            var n = [];
        ...
        return n(o, t), C(o, [ {
            key: "indexOf",
            value: function(t) {
                return D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "indexOf", this).call(this, E(t));
            }
        }, {
            key: "has",
            value: function(t) {
                return D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "has", this).call(this, E(t));
            }
        }, {
            key: "append",
            value: function(t, e) {
                return D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "append", this).call(this, E(t), e);
            }
        }, {
            key: "set",
            value: function(t, e) {
                return D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "set", this).call(this, E(t), e);
            }
        }, {
            key: "delete",
            value: function(t) {
                return D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "delete", this).call(this, E(t));
            }
        }, {
            key: "get",
            value: function(t) {
                return D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "getAll", this).call(this, E(t)).join(",");
            }
        }, {
            key: "entries",
            value: function() {
                var t = this, e = D(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "entries", this).call(this), n = [];
                return {
                    next: function() {
                        for (;;) {
    ...
    M.Headers || (M.Headers = ce);
    var fe = [ dt, vt, wt, gt, kt, Ot, jt, Et, St ], le = JSON.parse, he = 63, de = [ he, 127, 31, 15, 7, 3, 1 ], ye = 6, ve = function() {
        function t() {
        ...
        return C(t, [ {
            key: "initBody",
            value: function(t) {
                if (this.bodyInit = t, t) if (a(t)) this.bodyText = t; else if (S(t, Ut)) this.bodyBlob = t; else if (S(t, FormData)) this.bodyFormData = t; else if (S(t, URLSearchParams)) this.bodyText = t.toString(); else if (S(t, rt)) this.bodyArrayBuffer = U(t.buffer), 
                // IE 10-11 can't handle a DataView body.
                this.bodyInit = new Ut([ this.bodyArrayBuffer ]); else {
                    if (!S(t, et) && !T(t)) throw new Error("unsupported BodyInit type");
                    this.bodyArrayBuffer = U(t);
                } else this.bodyText = "";
                this.headers.get("content-type") || (a(t) ? this.headers.set("content-type", "text/plain;charset=UTF-8") : this.bodyBlob && this.bodyBlob.type ? this.headers.set("content-type", this.bodyBlob.type) : t instanceof URLSearchParams && this.headers.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"));
            }
        }, {
            key: "arrayBuffer",
            value: function() {
                return this.bodyArrayBuffer ? this.isUsed || Ft.resolve(this.bodyArrayBuffer) : this.blob().then(function(t) {
            ...
            value: function() {
                var t = this.isUsed;
                if (t) return t;
                if (this.bodyBlob) return Ft.resolve(this.bodyBlob);
                if (this.bodyArrayBuffer) return Ft.resolve(new Ut([ this.bodyArrayBuffer ]));
                if (this.bodyFormData) throw new Error("could not read FormData body as blob");
                return Ft.resolve(new Ut([ this.bodyText ]));
            }
        }, {
            key: "text",
            value: function() {
                var t = this.isUsed;
                if (t) return t;
                if (this.bodyBlob) return i(this.bodyBlob, "Text");
                if (this.bodyArrayBuffer) return Ft.resolve(R(this.bodyArrayBuffer));
                if (this.bodyFormData) throw new Error("could not read FormData body as text");
                return Ft.resolve(this.bodyText);
            }
        }, {
            key: "formData",
            value: function() {
            ...
            key: "isUsed",
            get: function() {
                if (this.bodyUsed) return Ft.reject(new lt("Already used"));
                this.bodyUsed = !0;
            }
        } ]), t;
    }(), pe = function(t) {
        function o(t) {
            ...
            !n.headers && a.headers || (a.headers = new ce(n.headers)), a.method = (n.method || a.method || "GET").toUpperCase(), 
        ...
        return n(o, t), C(o, [ {
            ...
            value: function(t, e, n) {
                ...
                return this.url = t.url, this.credentials = t.credentials, r || (this.headers = new ce(t.headers)), 
    ...
    }(ve), we = 200, me = 300, ge = [ 301, 302, 303, 307, 308 ], be = function(t) {
        function o(t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            r(this, o);
            var i = e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this));
            return i.type = "default", i.status = "status" in n ? n.status : we, i.ok = i.status >= we && i.status < me, 
            i.statusText = "statusText" in n ? n.statusText : "OK", i.headers = new ce(n.headers), 
        ...
        return n(o, t), C(o, [ {
            ...
            key: "redirect",
            value: function(t, e) {
                if (ge.indexOf(e) < 0) throw new RangeError("Invalid status code");
                return new o(null, {
                    status: e,
                    headers: {
                        location: t
    ...
    // }
    M.fetch = N, M.Body || (M.Body = ve), M.Response || (M.Response = be), M.Request || (M.Request = pe), 
    M.requestAnimationFrame = M.requestAnimationFrame || M.mozRequestAnimationFrame || M.webkitRequestAnimationFrame || M.msRequestAnimationFrame || function(t) {
        return it(function() {
            t(W.now());
        }, 30);
