!function() {
    ...
    function u(t, e, r) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, o = t.length, i = t[M] ? t[M]() : t;
        if (0 <= o) {
    ...
    function d(t) {
        for (var e = J(t, 10), r = [], n = 0; n < e; n += 1) c(r, this);
        return h(r, "");
    }
    ...
    function B(e) {
        ...
        return u(T(e).split("&"), function(e) {
            if (e) {
                ...
                i = $(i.replace(/\+/g, " ")), a = $(a.join("=").replace(/\+/g, " ")), r.append(i, a);
            }
        }), r;
    }
    /* eslint-disable no-bitwise */
    function F(t, e, r) {
        for (var n = Dt[r], o = 0, i = 0; 0 < r--; ) {
            var a = 0 === r ? n : It, u = Nt * i++;
            o |= (t[e + r] & a) << u;
        }
    ...
    function R(t) {
        for (var e = new et(t), r = [], n = 0; n < e.length; n++) {
            var o = e[n], i = void 0;
    ...
    function U(t) {
        ...
        var e = new et(t.byteLength);
        return e.set(new et(t)), e.buffer;
    }
    function I(e) {
        var r = new Headers();
        return e.replace(/\r?\n[\t ]+/, " ").split(/\r?\n/).forEach(function(e) {
    ...
    function D(t, e) {
        return new Promise(function(r, n) {
            var o = new Ct(t, e), i = new XMLHttpRequest();
            i.onload = function() {
                var t = {
                    status: i.status,
  ...
  */
    ...
    }), Symbol.iterator), z = 9007199254740991, K = window, X = K.String, Y = K.Object, J = K.parseInt, V = K.ArrayBuffer, Q = K.DataView, W = (K.location, 
    K.navigator, K.document, K.setTimeout), Z = K.clearTimeout, $ = K.decodeURIComponent, tt = (K.encodeURIComponent, 
    K.TypeError), et = K.Uint8Array, rt = K.Uint8ClampedArray, nt = K.Uint16Array, ot = K.Uint32Array, it = K.Int8Array, at = K.Int16Array, ut = K.Int32Array, st = K.Float32Array, ct = K.Float64Array, ft = 16, lt = function() {
        function t() {
        ...
        return C(t, [ {
            key: "get",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Date.now(), r = "Symbol(" + t + ")" + (this.seed + this.registry.length).toString(ft);
            ...
            value: function(t) {
                ...
                throw new tt("Symbol.for was called with non-string: " + t);
            }
        }, {
            key: "keyFor",
            value: function(t) {
    ...
    window.Symbol || (window.Symbol = new lt().Symbol), Array.prototype[M] || (Array.prototype[M] = s);
    var ht = Array.prototype.push;
    ...
    var dt = window, yt = dt.setImmediate, vt = void 0;
    vt = y, W(function() {
        // if (postMessage) {
    ...
    var pt = function(t) {
        return vt(t);
    }, wt = 0, mt = 1, gt = 2, bt = 3, kt = function t() {
        ...
        this.promise = new xt(f), /* eslint-enable no-use-before-define */
        this.onResolved = e, this.onRejected = r;
    }, xt = function() {
        function t(e) {
            n(this, t), this.deferreds = [], this.state = wt, this.exec(e);
        }
        return C(t, [ {
            key: "is",
            value: function(t) {
            ...
            value: function(t) {
                try {
                    if (t === this) throw new tt("A promise cannot be resolved with itself");
                    this.value = t, p(t) ? (this.state = bt, this.exec(function(e, r) {
                        t.then(e, r);
            ...
            value: function(t) {
                ...
                var e = this; e.is(bt); ) e = e.value;
                if (e.is(wt)) return void c(e.deferreds, t);
                pt(function() {
                    var r = t.promise, n = t.onResolved, o = void 0 === n ? null : n, i = t.onRejected, a = void 0 === i ? null : i, u = e.is(mt), s = u ? o : a;
    ...
    window.Promise = window.Promise || xt;
    var Ot = function() {
        function t(e) {
            var r = this;
    ...
    _t && 1 === new _t([ [ 0, 0 ] ]).size && _t.prototype.forEach || (_t = Ot), window.Map = _t, 
    Map.prototype[M] || (Map.prototype[M] = b);
    var At = function() {
        function t(e) {
            var r = this;
            n(this, t), this.clear(), e && u(e, function(t) {
    ...
    jt && 1 === new jt([ 0 ]).size && jt.prototype.forEach || (jt = At), window.Set = jt, 
    ...
    var Et = function() {
        ...
        function o(t) {
            return n(this, o), e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, t ? l(t.replace(/^\?/, "").split(Lt), function(t) {
                return t.split(Pt);
            }) : null));
        }
        return r(o, t), C(o, [ {
    ...
    }(Et), Tt = window, Bt = Tt.URLSearchParams;
    Bt && new Bt("?a=b").has("a") || (window.URLSearchParams = St);
    var Ft = function(t) {
        function o(t) {
            n(this, o);
            var r = [];
    ...
    window.Headers || (window.Headers = Ft);
    var Rt = [ et, rt, nt, ot, it, at, ut, st, ct ], Ut = JSON.parse, It = 63, Dt = [ It, 127, 31, 15, 7, 3, 1 ], Nt = 6, qt = function() {
        function t() {
        ...
        return C(t, [ {
            key: "initBody",
            value: function(t) {
                if (this.bodyInit = t, t) if (i(t)) this.bodyText = t; else if (L(t, Blob)) this.bodyBlob = t; else if (L(t, FormData)) this.bodyFormData = t; else if (L(t, URLSearchParams)) this.bodyText = t.toString(); else if (L(t, Q)) this.bodyArrayBuffer = U(t.buffer), 
                // IE 10-11 can't handle a DataView body.
                this.bodyInit = new Blob([ this.bodyArrayBuffer ]); else {
                    if (!L(t, V) && !S(t)) throw new Error("unsupported BodyInit type");
            ...
            key: "isUsed",
            get: function() {
                if (this.bodyUsed) return Promise.reject(new tt("Already used"));
                this.bodyUsed = !0;
            }
        } ]), t;
    }(), Ct = function(t) {
        function o(t) {
            ...
            !r.headers && a.headers || (a.headers = new Ft(r.headers)), a.method = (r.method || a.method || "GET").toUpperCase(), 
        ...
        return r(o, t), C(o, [ {
            ...
            value: function(t, e, r) {
                ...
                return this.url = t.url, this.credentials = t.credentials, n || (this.headers = new Ft(t.headers)), 
    ...
    }(qt), Gt = 200, Ht = 300, Mt = [ 301, 302, 303, 307, 308 ], zt = function(t) {
        function o(t) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            n(this, o);
            var i = e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this));
            return i.type = "default", i.status = "status" in r ? r.status : Gt, i.ok = i.status >= Gt && i.status < Ht, 
            i.statusText = "statusText" in r ? r.statusText : "OK", i.headers = new Ft(r.headers), 
        ...
        return r(o, t), C(o, [ {
            ...
            key: "redirect",
            value: function(t, e) {
                if (Mt.indexOf(e) < 0) throw new RangeError("Invalid status code");
                return new o(null, {
                    status: e,
                    headers: {
                        location: t
    ...
    // }
    window.fetch = D, window.Body || (window.Body = qt), window.Response || (window.Response = zt), 
    window.Request || (window.Request = Ct), window.requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
        return W(function() {
            t(Date.now());
        }, 30);
