!function() {
    ...
    function L(t) {
        return 0 <= m(Pt, function(e) {
            return E(t, e);
        });
    }
    /* eslint-disable no-bitwise */
    function S(t, e, r) {
        for (var n = Rt[r], o = 0, i = 0; 0 < r--; ) {
            var a = 0 === r ? n : Ft, u = Ut * i++;
            o |= (t[e + r] & a) << u;
        }
    ...
    function T(t) {
        for (var e = new xt(t), r = [], n = 0; n < e.length; n++) {
            var o = e[n], i = void 0;
    ...
    function P(t, e) {
        var r = new Ct(), n = new Promise(function(n, o) {
    ...
    function F(e) {
        var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : new Gt();
        return a(B(e).split("&"), function(e) {
            if (e) {
                var n = e.split("="), o = t(n), i = o[0], a = o.slice(1);
                i = Ht(i.replace(/\+/g, " ")), a = Ht(a.join("=").replace(/\+/g, " ")), r.append(i, a);
            }
        }), r;
    }
    function R(t) {
        if (t.slice) return t.slice(0);
        var e = new xt(t.byteLength);
        return e.set(new xt(t)), e.buffer;
    }
    function U(e) {
        var r = new Vt();
        return e.replace(/\r?\n[\t ]+/, " ").split(/\r?\n/).forEach(function(e) {
    ...
    function N(t, e) {
        return new qt(function(r, n) {
            var o = new zt(t, e), i = new Qt();
            i.onload = function() {
                var t = {
                    status: i.status,
  ...
  */
    ...
    NodeList.prototype[z] || (NodeList.prototype[z] = k);
    var vt = window.HTMLCollection;
    vt.prototype[z] || (vt.prototype[z] = x), NamedNodeMap.prototype[z] || (NamedNodeMap.prototype[z] = O);
    var pt = function() {
        function t(e) {
            var r = this;
        ...
        function o(t) {
            return n(this, o), e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, t ? l(t.replace(/^\?/, "").split(wt), function(t) {
                return t.split(mt);
            }) : null));
        }
        return r(o, t), C(o, [ {
    ...
    }(pt), bt = M.URLSearchParams;
    bt && new bt("?a=b").has("a") || (M.URLSearchParams = gt);
    var kt = function(t) {
        function o(t) {
            n(this, o);
            var r = [];
    ...
    M.Headers || (M.Headers = kt);
    var xt = window.Uint8Array, Ot = window.Uint8ClampedArray, _t = window.Uint16Array, jt = window.Uint32Array, At = window.Int8Array, Et = window.Int16Array, Lt = window.Int32Array, St = window.Float32Array, Tt = window.Float64Array, Pt = [ xt, Ot, _t, jt, At, Et, Lt, St, Tt ], Bt = JSON.parse, Ft = 63, Rt = [ Ft, 127, 31, 15, 7, 3, 1 ], Ut = 6, It = window.Blob, Nt = window.ArrayBuffer, Dt = window.DataView, qt = window.Promise, Ct = window.FileReader, Gt = window.FormData, Ht = window.decodeURIComponent, Mt = function() {
        function t() {
        ...
        return C(t, [ {
            key: "initBody",
            value: function(t) {
                if (this.bodyInit = t, t) if (u(t)) this.bodyText = t; else if (E(t, It)) this.bodyBlob = t; else if (E(t, Gt)) this.bodyFormData = t; else if (E(t, URLSearchParams)) this.bodyText = t.toString(); else if (E(t, Dt)) this.bodyArrayBuffer = R(t.buffer), 
                // IE 10-11 can't handle a DataView body.
                this.bodyInit = new It([ this.bodyArrayBuffer ]); else {
                    if (!E(t, Nt) && !L(t)) throw new Error("unsupported BodyInit type");
            ...
            key: "arrayBuffer",
            value: function() {
                return this.bodyArrayBuffer ? this.isUsed || qt.resolve(this.bodyArrayBuffer) : this.blob().then(function(t) {
            ...
            value: function() {
                var t = this.isUsed;
                if (t) return t;
                if (this.bodyBlob) return qt.resolve(this.bodyBlob);
                if (this.bodyArrayBuffer) return qt.resolve(new It([ this.bodyArrayBuffer ]));
                if (this.bodyFormData) throw new Error("could not read FormData body as blob");
                return qt.resolve(new It([ this.bodyText ]));
            }
        }, {
            key: "text",
            value: function() {
                ...
                if (this.bodyArrayBuffer) return qt.resolve(T(this.bodyArrayBuffer));
                if (this.bodyFormData) throw new Error("could not read FormData body as text");
                return qt.resolve(this.bodyText);
            }
        }, {
            key: "formData",
            value: function() {
            ...
            key: "isUsed",
            get: function() {
                if (this.bodyUsed) return qt.reject(new Y("Already used"));
                this.bodyUsed = !0;
            }
        } ]), t;
    }(), zt = function(t) {
        function o(t) {
            ...
            !r.headers && a.headers || (a.headers = new kt(r.headers)), a.method = (r.method || a.method || "GET").toUpperCase(), 
        ...
        return r(o, t), C(o, [ {
            ...
            value: function(t, e, r) {
                ...
                return this.url = t.url, this.credentials = t.credentials, n || (this.headers = new kt(t.headers)), 
    ...
    }(Mt), Kt = 200, Xt = 300, Yt = [ 301, 302, 303, 307, 308 ], Jt = function(t) {
        function o(t) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            n(this, o);
            ...
            i.statusText = "statusText" in r ? r.statusText : "OK", i.headers = new kt(r.headers), 
        ...
        return r(o, t), C(o, [ {
            ...
            key: "redirect",
            value: function(t, e) {
                if (Yt.indexOf(e) < 0) throw new RangeError("Invalid status code");
                return new o(null, {
                    status: e,
                    headers: {
                        location: t
    ...
    }(Mt), Vt = window.Headers, Qt = window.XMLHttpRequest;
    // if (!window.fetch) {
    // 	window.fetch = j0Fetch;
    // }
    M.fetch = N, M.Body || (M.Body = Mt), M.Response || (M.Response = Jt), M.Request || (M.Request = zt), 
