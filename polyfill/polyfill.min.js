!function() {
    ...
    function u(t, e, r) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, o = t.length, i = t[Tt] ? t[Tt]() : t;
        if (0 <= o) {
            for (var u = n; u < o; u += 1) if (e.call(r, t[u], u, t)) return;
        } else if (a(i.next)) for (var s = 0; s < Bt; ) {
    ...
    function d(t) {
        for (var e = V(t, 10), r = [], n = 0; n < e; n += 1) c(r, this);
        return h(r, "");
    }
    ...
    function P(e) {
        ...
        return u(B(e).split("&"), function(e) {
            if (e) {
                ...
                i = it(i.replace(/\+/g, " ")), a = it(a.join("=").replace(/\+/g, " ")), r.append(i, a);
            }
        }), r;
    }
    /* eslint-disable no-bitwise */
    function F(t, e, r) {
        for (var n = ie[r], o = 0, i = 0; 0 < r--; ) {
            var a = 0 === r ? n : oe, u = ae * i++;
            o |= (t[e + r] & a) << u;
        }
    ...
    function R(t) {
        for (var e = new ct(t), r = [], n = 0; n < e.length; n++) {
            var o = e[n], i = void 0;
    ...
    function U(t) {
        ...
        var e = new ct(t.byteLength);
        return e.set(new ct(t)), e.buffer;
    }
    function I(e) {
        var r = new Headers();
        return e.replace(/\r?\n[\t ]+/, " ").split(/\r?\n/).forEach(function(e) {
    ...
    function D(t, e) {
        return new St(function(r, n) {
            var o = new se(t, e), i = new Et();
            i.onload = function() {
                var t = {
                    status: i.status,
  ...
  */
        !function(e) {
            ...
            var A = "suspendedStart", j = "suspendedYield", E = "executing", L = "completed", S = {}, T = {};
            T[g] = function() {
                return this;
            };
    ...
    }), window), z = window, K = z.String, X = window, Y = X.Object, J = window, V = J.parseInt, Q = window, W = Q.ArrayBuffer, Z = window, $ = Z.DataView, tt = window, et = tt.setTimeout, rt = window, nt = rt.clearTimeout, ot = window, it = ot.decodeURIComponent, at = window, ut = at.TypeError, st = window, ct = st.Uint8Array, ft = window, lt = ft.Uint8ClampedArray, ht = window, dt = ht.Uint16Array, yt = window, vt = yt.Uint32Array, pt = window, wt = pt.Int8Array, mt = window, bt = mt.Int16Array, gt = window, kt = gt.Int32Array, xt = window, Ot = xt.Float32Array, _t = window, At = _t.Float64Array, jt = window, Et = jt.XMLHttpRequest, Lt = window, St = Lt.Promise, Tt = Symbol.iterator, Bt = 9007199254740991, Pt = 16, Ft = function() {
        function t() {
        ...
        return C(t, [ {
            key: "get",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Date.now(), r = "Symbol(" + t + ")" + (this.seed + this.registry.length).toString(Pt);
            ...
            value: function(t) {
                ...
                throw new ut("Symbol.for was called with non-string: " + t);
            }
        }, {
            key: "keyFor",
            value: function(t) {
    ...
    M.Symbol || (M.Symbol = Rt), Array.prototype[Tt] || (Array.prototype[Tt] = s);
    var Ut = Array.prototype.push;
    ...
    var It = M.setImmediate, Dt = void 0;
    Dt = y, et(function() {
        // if (postMessage) {
    ...
    var Nt = function(t) {
        return Dt(t);
    }, qt = 0, Ct = 1, Gt = 2, Ht = 3, Mt = function t() {
        ...
        this.promise = new zt(f), /* eslint-enable no-use-before-define */
        this.onResolved = e, this.onRejected = r;
    }, zt = function() {
        function t(e) {
            n(this, t), this.deferreds = [], this.state = qt, this.exec(e);
        }
        return C(t, [ {
            key: "is",
            value: function(t) {
            ...
            value: function(t) {
                try {
                    if (t === this) throw new ut("A promise cannot be resolved with itself");
                    this.value = t, p(t) ? (this.state = Ht, this.exec(function(e, r) {
                        t.then(e, r);
                    })) : this.state = Ct, this.finish();
                } catch (t) {
                    this.reject(t);
                }
            }
            ...
            key: "reject",
            value: function(t) {
                this.state = Gt, this.value = t, this.finish();
            }
        }, {
            key: "finish",
            value: function() {
            ...
            value: function(t) {
                ...
                var e = this; e.is(Ht); ) e = e.value;
                if (e.is(qt)) return void c(e.deferreds, t);
                Nt(function() {
                    var r = t.promise, n = t.onResolved, o = void 0 === n ? null : n, i = t.onRejected, a = void 0 === i ? null : i, u = e.is(Ct), s = u ? o : a;
    ...
    window.Promise = window.Promise || zt;
    var Kt = function() {
        function t(e) {
            var r = this;
    ...
    Xt && 1 === new Xt([ [ 0, 0 ] ]).size && Xt.prototype.forEach || (Xt = Kt), window.Map = Xt, 
    Map.prototype[Tt] || (Map.prototype[Tt] = g);
    var Yt = function() {
        function t(e) {
            var r = this;
            n(this, t), this.clear(), e && u(e, function(t) {
    ...
    Jt && 1 === new Jt([ 0 ]).size && Jt.prototype.forEach || (Jt = Yt), window.Set = Jt, 
    NodeList.prototype[Tt] || (NodeList.prototype[Tt] = k), HTMLCollection.prototype[Tt] || (HTMLCollection.prototype[Tt] = x), 
    NamedNodeMap.prototype[Tt] || (NamedNodeMap.prototype[Tt] = O);
    var Vt = function() {
        function t(e) {
            var r = this;
        ...
        function o(t) {
            return n(this, o), e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, t ? l(t.replace(/^\?/, "").split(Qt), function(t) {
                return t.split(Wt);
            }) : null));
        }
        return r(o, t), C(o, [ {
    ...
    }(Vt), $t = window, te = $t.URLSearchParams;
    te && new te("?a=b").has("a") || (window.URLSearchParams = Zt);
    var ee = function(t) {
        function o(t) {
            n(this, o);
            var r = [];
    ...
    window.Headers || (window.Headers = ee);
    var re = [ ct, lt, dt, vt, wt, bt, kt, Ot, At ], ne = JSON.parse, oe = 63, ie = [ oe, 127, 31, 15, 7, 3, 1 ], ae = 6, ue = function() {
        function t() {
        ...
        return C(t, [ {
            key: "initBody",
            value: function(t) {
                if (this.bodyInit = t, t) if (i(t)) this.bodyText = t; else if (L(t, Blob)) this.bodyBlob = t; else if (L(t, FormData)) this.bodyFormData = t; else if (L(t, URLSearchParams)) this.bodyText = t.toString(); else if (L(t, $)) this.bodyArrayBuffer = U(t.buffer), 
                // IE 10-11 can't handle a DataView body.
                this.bodyInit = new Blob([ this.bodyArrayBuffer ]); else {
                    if (!L(t, W) && !T(t)) throw new Error("unsupported BodyInit type");
            ...
            key: "arrayBuffer",
            value: function() {
                return this.bodyArrayBuffer ? this.isUsed || St.resolve(this.bodyArrayBuffer) : this.blob().then(function(t) {
            ...
            value: function() {
                var t = this.isUsed;
                if (t) return t;
                if (this.bodyBlob) return St.resolve(this.bodyBlob);
                if (this.bodyArrayBuffer) return St.resolve(new Blob([ this.bodyArrayBuffer ]));
                if (this.bodyFormData) throw new Error("could not read FormData body as blob");
                return St.resolve(new Blob([ this.bodyText ]));
            }
        }, {
            key: "text",
            value: function() {
                ...
                if (this.bodyArrayBuffer) return St.resolve(R(this.bodyArrayBuffer));
                if (this.bodyFormData) throw new Error("could not read FormData body as text");
                return St.resolve(this.bodyText);
            }
        }, {
            key: "formData",
            value: function() {
            ...
            key: "isUsed",
            get: function() {
                if (this.bodyUsed) return St.reject(new ut("Already used"));
                this.bodyUsed = !0;
            }
        } ]), t;
    }(), se = function(t) {
        function o(t) {
            ...
            !r.headers && a.headers || (a.headers = new ee(r.headers)), a.method = (r.method || a.method || "GET").toUpperCase(), 
        ...
        return r(o, t), C(o, [ {
            ...
            value: function(t, e, r) {
                ...
                return this.url = t.url, this.credentials = t.credentials, n || (this.headers = new ee(t.headers)), 
    ...
    }(ue), ce = 200, fe = 300, le = [ 301, 302, 303, 307, 308 ], he = function(t) {
        function o(t) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            n(this, o);
            var i = e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this));
            return i.type = "default", i.status = "status" in r ? r.status : ce, i.ok = i.status >= ce && i.status < fe, 
            i.statusText = "statusText" in r ? r.statusText : "OK", i.headers = new ee(r.headers), 
        ...
        return r(o, t), C(o, [ {
            ...
            key: "redirect",
            value: function(t, e) {
                if (le.indexOf(e) < 0) throw new RangeError("Invalid status code");
                return new o(null, {
                    status: e,
                    headers: {
                        location: t
    ...
    // }
    window.fetch = D, window.Body || (window.Body = ue), window.Response || (window.Response = he), 
    window.Request || (window.Request = se), M.requestAnimationFrame = M.requestAnimationFrame || M.mozRequestAnimationFrame || M.webkitRequestAnimationFrame || M.msRequestAnimationFrame || function(t) {
        return et(function() {
            t(Date.now());
        }, 30);
