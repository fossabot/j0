!function() {
    ...
    function u(t, e, r) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, o = t.length, i = t[Rt] ? t[Rt]() : t;
        if (0 <= o) {
            for (var u = n; u < o; u += 1) if (e.call(r, t[u], u, t)) return;
        } else if (a(i.next)) for (var s = 0; s < Ut; ) {
    ...
    function d(t) {
        for (var e = W(t, 10), r = [], n = 0; n < e; n += 1) c(r, this);
        return h(r, "");
    }
    ...
    function B(e) {
        ...
        return u(P(e).split("&"), function(e) {
            if (e) {
                ...
                i = ut(i.replace(/\+/g, " ")), a = ut(a.join("=").replace(/\+/g, " ")), r.append(i, a);
            }
        }), r;
    }
    /* eslint-disable no-bitwise */
    function F(t, e, r) {
        for (var n = ce[r], o = 0, i = 0; 0 < r--; ) {
            var a = 0 === r ? n : se, u = fe * i++;
            o |= (t[e + r] & a) << u;
        }
    ...
    function R(t) {
        for (var e = new lt(t), r = [], n = 0; n < e.length; n++) {
            var o = e[n], i = void 0;
  ...
  */
    ...
    }), window), z = window, K = z.String, X = window, Y = X.Array, J = window, V = J.Object, Q = window, W = Q.parseInt, Z = window, $ = Z.ArrayBuffer, tt = window, et = tt.DataView, rt = window, nt = rt.setTimeout, ot = window, it = ot.clearTimeout, at = window, ut = at.decodeURIComponent, st = window, ct = st.TypeError, ft = window, lt = ft.Uint8Array, ht = window, dt = ht.Uint8ClampedArray, yt = window, vt = yt.Uint16Array, pt = window, wt = pt.Uint32Array, mt = window, gt = mt.Int8Array, bt = window, kt = bt.Int16Array, xt = window, Ot = xt.Int32Array, _t = window, jt = _t.Float32Array, At = window, Et = At.Float64Array, Lt = window, St = Lt.XMLHttpRequest, Tt = window, Pt = Tt.Promise, Bt = window, Ft = Bt.Blob, Rt = Symbol.iterator, Ut = 9007199254740991, It = 16, Dt = function() {
        function t() {
        ...
        return C(t, [ {
            key: "get",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Date.now(), r = "Symbol(" + t + ")" + (this.seed + this.registry.length).toString(It);
    ...
    M.Symbol || (M.Symbol = Nt);
    var qt = Y.prototype;
    qt[Rt] || (qt[Rt] = s);
    var Ct = Y.prototype.push;
    ...
    var Gt = M.setImmediate, Ht = void 0;
    Ht = y, nt(function() {
        // if (postMessage) {
    ...
    var Mt = function(t) {
        return Ht(t);
    }, zt = 0, Kt = 1, Xt = 2, Yt = 3, Jt = function t() {
        ...
        this.promise = new Vt(f), /* eslint-enable no-use-before-define */
        this.onResolved = e, this.onRejected = r;
    }, Vt = function() {
        function t(e) {
            n(this, t), this.deferreds = [], this.state = zt, this.exec(e);
        }
        return C(t, [ {
            key: "is",
            value: function(t) {
            ...
            value: function(t) {
                try {
                    ...
                    this.value = t, p(t) ? (this.state = Yt, this.exec(function(e, r) {
                        t.then(e, r);
                    })) : this.state = Kt, this.finish();
                } catch (t) {
                    this.reject(t);
                }
            }
            ...
            key: "reject",
            value: function(t) {
                this.state = Xt, this.value = t, this.finish();
            }
        }, {
            key: "finish",
            value: function() {
            ...
            value: function(t) {
                ...
                var e = this; e.is(Yt); ) e = e.value;
                if (e.is(zt)) return void c(e.deferreds, t);
                Mt(function() {
                    var r = t.promise, n = t.onResolved, o = void 0 === n ? null : n, i = t.onRejected, a = void 0 === i ? null : i, u = e.is(Kt), s = u ? o : a;
    ...
    Wt && 1 === new Wt([ [ 0, 0 ] ]).size && Wt.prototype.forEach || (Wt = Qt), M.Map = Wt, 
    Map.prototype[Rt] || (Map.prototype[Rt] = b);
    var Zt = function() {
        function t(e) {
            var r = this;
            n(this, t), this.clear(), e && u(e, function(t) {
    ...
    $t && 1 === new $t([ 0 ]).size && $t.prototype.forEach || ($t = Zt), M.Set = $t, 
    NodeList.prototype[Rt] || (NodeList.prototype[Rt] = k), HTMLCollection.prototype[Rt] || (HTMLCollection.prototype[Rt] = x), 
    NamedNodeMap.prototype[Rt] || (NamedNodeMap.prototype[Rt] = O);
    var te = function() {
        function t(e) {
            var r = this;
        ...
        function o(t) {
            return n(this, o), e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, t ? l(t.replace(/^\?/, "").split(ee), function(t) {
                return t.split(re);
            }) : null));
        }
        return r(o, t), C(o, [ {
    ...
    }(te), oe = M.URLSearchParams;
    oe && new oe("?a=b").has("a") || (M.URLSearchParams = ne);
    var ie = function(t) {
        function o(t) {
            n(this, o);
            var r = [];
    ...
    M.Headers || (M.Headers = ie);
    var ae = [ lt, dt, vt, wt, gt, kt, Ot, jt, Et ], ue = JSON.parse, se = 63, ce = [ se, 127, 31, 15, 7, 3, 1 ], fe = 6, le = function() {
        function t() {
        ...
        return C(t, [ {
            key: "initBody",
            value: function(t) {
                if (this.bodyInit = t, t) if (i(t)) this.bodyText = t; else if (L(t, Ft)) this.bodyBlob = t; else if (L(t, FormData)) this.bodyFormData = t; else if (L(t, URLSearchParams)) this.bodyText = t.toString(); else if (L(t, et)) this.bodyArrayBuffer = U(t.buffer), 
                // IE 10-11 can't handle a DataView body.
                this.bodyInit = new Ft([ this.bodyArrayBuffer ]); else {
            ...
            key: "arrayBuffer",
            value: function() {
                return this.bodyArrayBuffer ? this.isUsed || Pt.resolve(this.bodyArrayBuffer) : this.blob().then(function(t) {
            ...
            value: function() {
                var t = this.isUsed;
                if (t) return t;
                if (this.bodyBlob) return Pt.resolve(this.bodyBlob);
                if (this.bodyArrayBuffer) return Pt.resolve(new Ft([ this.bodyArrayBuffer ]));
                if (this.bodyFormData) throw new Error("could not read FormData body as blob");
                return Pt.resolve(new Ft([ this.bodyText ]));
            }
        }, {
            key: "text",
            value: function() {
                ...
                if (this.bodyArrayBuffer) return Pt.resolve(R(this.bodyArrayBuffer));
                if (this.bodyFormData) throw new Error("could not read FormData body as text");
                return Pt.resolve(this.bodyText);
            }
        }, {
            key: "formData",
            value: function() {
            ...
            key: "isUsed",
            get: function() {
                if (this.bodyUsed) return Pt.reject(new ct("Already used"));
                this.bodyUsed = !0;
            }
        } ]), t;
    }(), he = function(t) {
        function o(t) {
            ...
            !r.headers && a.headers || (a.headers = new ie(r.headers)), a.method = (r.method || a.method || "GET").toUpperCase(), 
        ...
        return r(o, t), C(o, [ {
            ...
            value: function(t, e, r) {
                ...
                return this.url = t.url, this.credentials = t.credentials, n || (this.headers = new ie(t.headers)), 
    ...
    }(le), de = 200, ye = 300, ve = [ 301, 302, 303, 307, 308 ], pe = function(t) {
        function o(t) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            n(this, o);
            var i = e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this));
            return i.type = "default", i.status = "status" in r ? r.status : de, i.ok = i.status >= de && i.status < ye, 
            i.statusText = "statusText" in r ? r.statusText : "OK", i.headers = new ie(r.headers), 
        ...
        return r(o, t), C(o, [ {
            ...
            key: "redirect",
            value: function(t, e) {
                if (ve.indexOf(e) < 0) throw new RangeError("Invalid status code");
                return new o(null, {
                    status: e,
                    headers: {
                        location: t
    ...
    // }
    M.fetch = D, M.Body || (M.Body = le), M.Response || (M.Response = pe), M.Request || (M.Request = he), 
