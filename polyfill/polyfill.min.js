!function() {
    ...
    function u(t, e, r) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, o = t.length, i = t[Lt] ? t[Lt]() : t;
        if (0 <= o) {
            for (var u = n; u < o; u += 1) if (e.call(r, t[u], u, t)) return;
        } else if (a(i.next)) for (var s = 0; s < Pt; ) {
    ...
    function F(t, e, r) {
        for (var n = ne[r], o = 0, i = 0; 0 < r--; ) {
            var a = 0 === r ? n : re, u = oe * i++;
            o |= (t[e + r] & a) << u;
        }
    ...
    function I(e) {
        ...
        return e.replace(/\r?\n[\t ]+/, " ").split(/\r?\n/).forEach(function(e) {
            var n = e.split(":"), o = t(n), i = o[0], a = o.slice(1);
            i && r.append(T(i), T(a.join(":")));
        }), r;
    }
    function D(t, e) {
        return new Promise(function(r, n) {
            var o = new ae(t, e), i = new Et();
            i.onload = function() {
                var t = {
                    status: i.status,
  ...
  */
            ...
            F[g] = function() {
                ...
                finish: function(t) {
                    for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                        ...
                        if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), h(r), P;
                    }
                },
                catch: function(t) {
                    for (var e = this.tryEntries.length - 1; e >= 0; --e) {
        ...
        return C(t, [ {
            key: "get",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Date.now(), r = "Symbol(" + t + ")" + (this.seed + this.registry.length).toString(St);
    ...
    M.Symbol || (M.Symbol = Bt), Array.prototype[Lt] || (Array.prototype[Lt] = s);
    var Ft = Array.prototype.push;
    ...
    var Rt = M.setImmediate, Ut = void 0;
    Ut = y, et(function() {
        // if (postMessage) {
    ...
    var It = function(t) {
        return Ut(t);
    }, Dt = 0, Nt = 1, qt = 2, Ct = 3, Gt = function t() {
        ...
        this.promise = new Ht(f), /* eslint-enable no-use-before-define */
        this.onResolved = e, this.onRejected = r;
    }, Ht = function() {
        function t(e) {
            n(this, t), this.deferreds = [], this.state = Dt, this.exec(e);
        }
        return C(t, [ {
            key: "is",
            value: function(t) {
            ...
            value: function(t) {
                try {
                    ...
                    this.value = t, p(t) ? (this.state = Ct, this.exec(function(e, r) {
                        t.then(e, r);
                    })) : this.state = Nt, this.finish();
                } catch (t) {
                    this.reject(t);
                }
            }
            ...
            value: function(t) {
                ...
                var e = this; e.is(Ct); ) e = e.value;
                if (e.is(Dt)) return void c(e.deferreds, t);
                It(function() {
                    var r = t.promise, n = t.onResolved, o = void 0 === n ? null : n, i = t.onRejected, a = void 0 === i ? null : i, u = e.is(Nt), s = u ? o : a;
    ...
    window.Promise = window.Promise || Ht;
    var Mt = function() {
        function t(e) {
            var r = this;
    ...
    zt && 1 === new zt([ [ 0, 0 ] ]).size && zt.prototype.forEach || (zt = Mt), window.Map = zt, 
    Map.prototype[Lt] || (Map.prototype[Lt] = g);
    var Kt = function() {
        function t(e) {
            var r = this;
            n(this, t), this.clear(), e && u(e, function(t) {
    ...
    Xt && 1 === new Xt([ 0 ]).size && Xt.prototype.forEach || (Xt = Kt), window.Set = Xt, 
    NodeList.prototype[Lt] || (NodeList.prototype[Lt] = k), HTMLCollection.prototype[Lt] || (HTMLCollection.prototype[Lt] = x), 
    NamedNodeMap.prototype[Lt] || (NamedNodeMap.prototype[Lt] = O);
    var Yt = function() {
        function t(e) {
            var r = this;
        ...
        function o(t) {
            return n(this, o), e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, t ? l(t.replace(/^\?/, "").split(Jt), function(t) {
                return t.split(Vt);
            }) : null));
        }
        return r(o, t), C(o, [ {
    ...
    }(Yt), Wt = window, Zt = Wt.URLSearchParams;
    Zt && new Zt("?a=b").has("a") || (window.URLSearchParams = Qt);
    var $t = function(t) {
        function o(t) {
            n(this, o);
            var r = [];
    ...
    window.Headers || (window.Headers = $t);
    var te = [ ct, lt, dt, vt, wt, bt, kt, Ot, At ], ee = JSON.parse, re = 63, ne = [ re, 127, 31, 15, 7, 3, 1 ], oe = 6, ie = function() {
        function t() {
        ...
        return C(t, [ {
            ...
            value: function(t) {
                ...
                this.bodyInit = new Blob([ this.bodyArrayBuffer ]); else {
                    if (!L(t, W) && !S(t)) throw new Error("unsupported BodyInit type");
            ...
            key: "isUsed",
            get: function() {
                if (this.bodyUsed) return Promise.reject(new ut("Already used"));
                this.bodyUsed = !0;
            }
        } ]), t;
    }(), ae = function(t) {
        function o(t) {
            ...
            !r.headers && a.headers || (a.headers = new $t(r.headers)), a.method = (r.method || a.method || "GET").toUpperCase(), 
        ...
        return r(o, t), C(o, [ {
            ...
            value: function(t, e, r) {
                ...
                return this.url = t.url, this.credentials = t.credentials, n || (this.headers = new $t(t.headers)), 
    ...
    }(ie), ue = 200, se = 300, ce = [ 301, 302, 303, 307, 308 ], fe = function(t) {
        function o(t) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            n(this, o);
            var i = e(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this));
            return i.type = "default", i.status = "status" in r ? r.status : ue, i.ok = i.status >= ue && i.status < se, 
            i.statusText = "statusText" in r ? r.statusText : "OK", i.headers = new $t(r.headers), 
        ...
        return r(o, t), C(o, [ {
            ...
            key: "redirect",
            value: function(t, e) {
                if (ce.indexOf(e) < 0) throw new RangeError("Invalid status code");
                return new o(null, {
                    status: e,
                    headers: {
                        location: t
    ...
    // }
    window.fetch = D, window.Body || (window.Body = ie), window.Response || (window.Response = fe), 
    window.Request || (window.Request = ae), M.requestAnimationFrame = M.requestAnimationFrame || M.mozRequestAnimationFrame || M.webkitRequestAnimationFrame || M.msRequestAnimationFrame || function(t) {
        return et(function() {
            t(Date.now());
        }, 30);
